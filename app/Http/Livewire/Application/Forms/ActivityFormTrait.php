    ...
    public function getActivityForm()
    {
        return [
            Placeholder::make('section_school_activity')
                ...
                <p class="font-bold color-red-800">List up to four current extracurricular activities that you are most passionate about. You must list at least one activity.</p>
            ')),
