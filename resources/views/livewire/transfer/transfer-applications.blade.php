    ...
    <section x-data="{ open: $wire.entangle('open') }">
        ...
        <div class="mt-8" x-show="!open" x-cloak>
            ...
            <div class="max-w-lg mx-auto text-center">
                ...
                <h3 class="mt-8 text-2xl font-bold">Transfer Application Period Ended.</h3>
                <p class="mt-4 text-sm text-gray-700">
                    We regret to inform you that the transfer application period has come to a close. Thank you for your interest. Stay tuned for future opportunities.
                </p>
            </div>
        </div>
    </section>
