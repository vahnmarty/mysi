    ...
    >
        @if (count($containers))
            <ul>
                <x-filament-support::grid
                    ...
                    wire:sortable
                    wire:end.stop="dispatchFormEvent('parentRepeater::moveItems', '{{ $getStatePath() }}', $event.target.sortable.toArray())"
                    class="gap-6"
                >
                                ...
                                >
                                    @unless ($isItemMovementDisabled)
                                        <button
                                            ...
                                            wire:keydown.prevent.arrow-up="dispatchFormEvent('parentRepeater::moveItemUp', '{{ $getStatePath() }}', '{{ $uuid }}')"
                                            wire:keydown.prevent.arrow-down="dispatchFormEvent('parentRepeater::moveItemDown', '{{ $getStatePath() }}', '{{ $uuid }}')"
                                            type="button"
                                            @class([
                                            ...
                                            @unless ($loop->first)
                                                <li>
                                                    <button
                                                        ...
                                                        type="button"
                                                        wire:click.stop="dispatchFormEvent('parentRepeater::moveItemUp', '{{ $getStatePath() }}', '{{ $uuid }}')"
                                                        wire:target="dispatchFormEvent('parentRepeater::moveItemUp', '{{ $getStatePath() }}', '{{ $uuid }}')"
                                            ...
                                            @unless ($loop->last)
                                                <li>
                                                    <button
                                                        ...
                                                        type="button"
                                                        wire:click.stop="dispatchFormEvent('parentRepeater::moveItemDown', '{{ $getStatePath() }}', '{{ $uuid }}')"
                                                        wire:target="dispatchFormEvent('parentRepeater::moveItemDown', '{{ $getStatePath() }}', '{{ $uuid }}')"
                                                        wire:loading.attr="disabled"
                                                        @class([
                                                            'flex h-10 w-10 flex-none items-center justify-center text-gray-400 outline-none transition hover:text-gray-500 focus:bg-gray-500/5',
                                                            'dark:border-gray-700 dark:focus:bg-gray-600/20' => config('forms.dark_mode'),
                                        ...
                                        @if ($isCloneable)
                                            <li>
                                                <button
                                                    ...
                                                    wire:click.stop="dispatchFormEvent('parentRepeater::cloneItem', '{{ $getStatePath() }}', '{{ $uuid }}')"
                                                    wire:target="dispatchFormEvent('parentRepeater::cloneItem', '{{ $getStatePath() }}', '{{ $uuid }}')"
                                                    wire:loading.attr="disabled"
                                                    type="button"
                                                    @class([
                                                        'flex h-10 w-10 flex-none items-center justify-center text-gray-400 outline-none transition hover:text-gray-500 focus:bg-gray-500/5',
                                        ...
                                        @unless ($isItemDeletionDisabled)
                                            <li>
                                                <button
                                                    ...
                                                    wire:click.stop="dispatchFormEvent('parentRepeater::deleteItem', '{{ $getStatePath() }}', '{{ $uuid }}')"
                                                    wire:target="dispatchFormEvent('parentRepeater::deleteItem', '{{ $getStatePath() }}', '{{ $uuid }}')"
                                                    wire:loading.attr="disabled"
                                                    type="button"
                                                    @class([
        ...
        @if (! $isItemCreationDisabled)
            <div class="relative flex justify-center">
                <x-forms::button
                    :wire:click="'dispatchFormEvent(\'parentRepeater::createItem\', \'' . $getStatePath() . '\')'"
                    size="sm"
                    outlined
                >
